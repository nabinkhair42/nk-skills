...
# nk-skills installer
# Installs skills into project skill directories for Cursor and Claude,
...
print_ascii() {
  ...
  printf " ${B}███${D}╗  ${B}██${D}╗${B}██${D}╗  ${B}██${D}╗    ${B}███████${D}╗${B}██${D}╗  ${B}██${D}╗${B}██${D}╗${B}██${D}╗     ${B}██${D}╗     ${B}███████${D}╗\n"
  printf " ${B}████${D}╗ ${B}██${D}║${B}██${D}║ ${B}██${D}╔╝    ${B}██${D}╔════╝${B}██${D}║ ${B}██${D}╔╝${B}██${D}║${B}██${D}║     ${B}██${D}║     ${B}██${D}╔════╝\n"
  printf " ${B}██${D}╔${B}██${D}╗${B}██${D}║${B}█████${D}╔╝     ${B}███████${D}╗${B}█████${D}╔╝ ${B}██${D}║${B}██${D}║     ${B}██${D}║     ${B}███████${D}╗\n"
  printf " ${B}██${D}║╚${B}████${D}║${B}██${D}╔═${B}██${D}╗     ${D}╚════${B}██${D}║${B}██${D}╔═${B}██${D}╗ ${B}██${D}║${B}██${D}║     ${B}██${D}║     ${D}╚════${B}██${D}║\n"
  printf " ${B}██${D}║ ╚${B}███${D}║${B}██${D}║  ${B}██${D}╗    ${B}███████${D}║${B}██${D}║  ${B}██${D}╗${B}██${D}║${B}███████${D}╗${B}███████${D}╗${B}███████${D}║\n"
  printf " ${D}╚═╝  ╚══╝╚═╝  ╚═╝    ╚══════╝╚═╝  ╚═╝╚═╝╚══════╝╚══════╝╚══════╝${R}\n"
  printf "\n"
  printf "  ${DARK}reusable skills for product engineers.${R}\n"
}
...
description = "Apply nk-skills to review code"
prompt = """
TOMLEOF
